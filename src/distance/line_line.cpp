...
namespace autogen {
        ...
        double g[12])
    {
        ...
        */
        ...
        t77 = (t16 * t44 + t13 * t46) + -(t15 * t45);
        t76 = t75 * t75;
        t78 = t77 * t77;
        t81 = (t12 * t44 * 2.0 + t14 * t45 * 2.0) * t76 * t78;
        t82 = (t11 * t45 * 2.0 + t12 * t46 * 2.0) * t76 * t78;
        t83 = (t18 * t44 * 2.0 + t19 * t45 * 2.0) * t76 * t78;
        t18 = (t17 * t45 * 2.0 + t18 * t46 * 2.0) * t76 * t78;
        t85 = (t11 * t44 * 2.0 + -(t14 * t46 * 2.0)) * t76 * t78;
        t19 = (t17 * t44 * 2.0 + -(t19 * t46 * 2.0)) * t76 * t78;
        t78 = 1.0 / sqrt(t75 * t78);
        t76 = t75 * t77;
        g[0] = t78 * (t83 - t76 * ((-t36 + t37) + t46) * 2.0) * -0.5;
        g[1] = t78 * (t19 - t76 * ((-t34 + t35) + t45) * 2.0) / 2.0;
        g[2] = t78 * (t18 + t76 * ((-t30 + t31) + t44) * 2.0) / 2.0;
        g[3] = t78 * (t83 + t76 * (t36 - t37) * 2.0) / 2.0;
        g[4] = t78 * (t19 + t76 * (t34 - t35) * 2.0) * -0.5;
        g[5] = t78 * (t18 - t76 * (t30 - t31) * 2.0) * -0.5;
        t17 = t12 * t16 + -(t14 * t15);
        g[6] = t78 * (t81 - t76 * (t17 + t46) * 2.0) / 2.0;
        t19 = t11 * t16 + -(t13 * t14);
        g[7] = t78 * (t85 - t76 * (t19 + t45) * 2.0) * -0.5;
        t18 = t11 * t15 + -(t12 * t13);
        g[8] = t78 * (t82 + t76 * (t18 + t44) * 2.0) * -0.5;
        g[9] = t78 * (t81 - t76 * t17 * 2.0) * -0.5;
        g[10] = t78 * (t85 - t76 * t19 * 2.0) / 2.0;
        g[11] = t78 * (t82 + t76 * t18 * 2.0) / 2.0;
    }
