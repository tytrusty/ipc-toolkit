...
namespace autogen {
        ...
        double in1[12], double g[12])
    {
        ...
        */
        ...
        t46 = t43 * t45;
        g[3] = t48 *
                (g_tmp * (t21 * t32 * 2.0 + t22 * t33 * 2.0) +
                t46 * ((t34 + t12 * t22) - t13 * t21) * 2.0) *
                -0.5;
        g[4] = t48 *
                (g_tmp * (t19 * t32 * 2.0 - t22 * t34 * 2.0) +
                t46 * ((t33 - t13 * t19) + t11 * t22) * 2.0) /
                2.0;
        g[5] = t48 *
                (g_tmp * (t19 * t33 * 2.0 + t21 * t34 * 2.0) -
                t46 * ((t32 - t12 * t19) + t11 * t21) * 2.0) /
                2.0;
        g[6] = t48 *
                (t46 * (t13 * t18 - t12 * t20) * 2.0 -
                g_tmp * (t18 * t32 * 2.0 + t20 * t33 * 2.0)) *
                -0.5;
        g[7] = t48 *
                (t46 * (t13 * t16 - t11 * t20) * 2.0 -
                g_tmp * (t16 * t32 * 2.0 - t20 * t34 * 2.0)) /
                2.0;
        g[8] = t48 *
                (t46 * (t12 * t16 - t11 * t18) * 2.0 +
                g_tmp * (t16 * t33 * 2.0 + t18 * t34 * 2.0)) *
                -0.5;
        g[9] = t48 *
                (t46 * (t13 * t15 - t12 * t17) * 2.0 -
                g_tmp * (t15 * t32 * 2.0 + t17 * t33 * 2.0)) /
                2.0;
        g[10] = t48 *
                (t46 * (t13 * t14 - t11 * t17) * 2.0 -
                g_tmp * (t14 * t32 * 2.0 - t17 * t34 * 2.0)) *
                -0.5;
        g[11] = t48 *
                (t46 * (t11 * t15 - t12 * t14) * 2.0 -
                g_tmp * (t14 * t33 * 2.0 + t15 * t34 * 2.0)) *
                -0.5;
    }
