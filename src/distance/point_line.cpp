...
namespace autogen {
        ...
        double g[6])
    {
        ...
        t25 =
            ((v11 * v22 + -(v12 * v21)) + v01 * t14) + -(v02 * t13);
        t24 = t23 * t23;
        t26 = t25 * t25;
        t29 = (v11 * 2.0 + -(v21 * 2.0)) * t24 * t26;
        t30 = (v12 * 2.0 + -(v22 * 2.0)) * t24 * t26;
        if (t23 * t26 == 0) {
            g[0]=0.0;
            g[1]=0.0;
            g[2]=0.0;
        ...
        t26 = 1.0 / sqrt(t23 * t26);
        g[0] = t14 * t23 * t25 * t26;
        g[1] = -t13 * t23 * t25 * t26;
        t24 = t23 * t25;
        g[2] = t26 * (t29 + t24 * (v02 + -v22) * 2.0) * -0.5;
        g[3] = t26 * (t30 - t24 * (v01 + -v21) * 2.0) * -0.5;
        g[4] = t26 * (t29 + t24 * (v02 - v12) * 2.0) / 2.0;
        g[5] = t26 * (t30 - t24 * (v01 - v11) * 2.0) / 2.0;
        ...
        double g[9])
    {
        ...
        t24 = in1[4] + -in1[7];
        t25 = in1[5] + -in1[8];
        t42 = 1.0 / ((t22 * t22 + t24 * t24) + t25 * t25);
        t44 = t17 * t21 + -(t18 * t19);
        t45 = t17 * t23 + -(t19 * t20);
        t46 = t18 * t23 + -(t20 * t21);
        t43 = t42 * t42;
        t50 = (t44 * t44 + t45 * t45) + t46 * t46;
        t53 = (in1[3] * 2.0 + -(in1[6] * 2.0)) * t43 * t50;
        t54 = (in1[4] * 2.0 + -(in1[7] * 2.0)) * t43 * t50;
        t55 = (in1[5] * 2.0 + -(in1[8] * 2.0)) * t43 * t50;
        t43 = 1.0 / std::sqrt(t42 * t50);
        t50 = t42 * t43;
        g[0] = t50 * (t24 * t44 * 2.0 + t25 * t45 * 2.0) / 2.0;
        g[1] = t50 * (t22 * t44 * 2.0 - t25 * t46 * 2.0) * -0.5;
        g[2] = t50 * (t22 * t45 * 2.0 + t24 * t46 * 2.0) * -0.5;
        g[3] = t43 * (t53 + t42 * (t21 * t44 * 2.0 + t23 * t45 * 2.0)) * -0.5;
        g[4] = t43 * (t54 - t42 * (t19 * t44 * 2.0 - t23 * t46 * 2.0)) * -0.5;
        g[5] = t43 * (t55 - t42 * (t19 * t45 * 2.0 + t21 * t46 * 2.0)) * -0.5;
        g[6] = t43 * (t53 + t42 * (t18 * t44 * 2.0 + t20 * t45 * 2.0)) / 2.0;
        g[7] = t43 * (t54 - t42 * (t17 * t44 * 2.0 - t20 * t46 * 2.0)) / 2.0;
        g[8] = t43 * (t55 - t42 * (t17 * t45 * 2.0 + t18 * t46 * 2.0)) / 2.0;
    }
